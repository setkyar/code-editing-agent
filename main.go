...
// Agent struct for managing the conversation
type Agent struct {
...
// NewAgent creates a new agent with the given client, message getter, and tools
...
// runInference sends the conversation to the Anthropic API and gets a response
